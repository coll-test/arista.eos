...
class TestEosLacpInterfacesModule(TestEosModule):
    ...
    def setUp(self):
        ...
        self.mock_execute_show_command = patch('ansible_collections.arista.eos.plugins.module_utils.network.eos.facts.lacp_interfaces.lacp_interfaces.Lacp_interfacesFacts.get_device_data')
